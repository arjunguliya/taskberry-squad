...
export default function TeamMembersManager() {
  ...
  // ENHANCED: Approval handler with hierarchy validation
  const handleApproveUser = async () => {
    ...
    if (approvalDialog.selectedRole === 'team_member') {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ENHANCED Approval Dialog with Hierarchy */}
            ...
            <div className="space-y-6">
              ...
              {approvalDialog.selectedRole && (
                <div className="text-xs text-muted-foreground">
                  {approvalDialog.selectedRole === 'team_member' && 'Team members require both supervisor and manager assignments'}
